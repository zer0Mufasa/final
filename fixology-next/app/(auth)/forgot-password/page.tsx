      ...
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-6 py-12 lg:px-12 bg-[#0a0a0f]">
          <div className="w-full max-w-[440px]">
            <div className="bg-[rgba(18,18,26,0.8)] backdrop-blur-[20px] border border-white/8 rounded-3xl p-12 shadow-2xl relative overflow-hidden text-center animate-[fadeInScale_0.4s_ease-out]">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#a78bfa] to-transparent opacity-50" />
              
              <div className="w-16 h-16 bg-green-500/20 border-2 border-green-500 rounded-full flex items-center justify-center mx-auto mb-6 animate-[checkmark_0.5s_ease-out_0.2s_both]">
